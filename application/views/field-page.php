                                ...
                                <form id="station-form" name="station-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/field/save/'  method="post">            
                                    ...
                                    <div class="span6"> 
                                        ...
                                        <div class="controls">
                                            ...
                                            <select class="span6" id="location" name="location" >                                                            
                                            ...
                                            foreach ($fd as $loop) {
                                                ...
                                                <tr id="<?php echo $id; ?>" class="edit_tr">
                                                    ...
                                                    <td class="edit_td">
                                                        ...
                                                        <span id="notes_<?php echo $id; ?>" class="text">
                                                            <?php
                                                            //echo $abstract;
                                                        ...
                                                        <textarea type="text" value="<?php echo $notes; ?>" class="editbox" id="notes_input_<?php echo $id; ?>"><?php echo $notes; ?></textarea>
