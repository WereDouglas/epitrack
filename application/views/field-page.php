...
<div class="col-xs-12">
    ...
    <div class="row-fluid">
        <a href="javascript:void(0);" class="add_user" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus-square"></i> <span> New field work</span> </a>
        <?php echo $this->session->flashdata('msg'); ?>
                        ...
                        foreach ($fd as $loop) {
                            ...
                            <tr id="<?php echo $id; ?>" class="edit_tr">
                                ...
                                <td class="edit_td">
                                    ...
                                    <select name="location" class="editbox" id="location_input_<?php echo $id; ?>" >                                                            
                                        <option value="<?php echo $location; ?>" title="<?php echo $location; ?>"><?php echo $location; ?></option>                                                          
                                ...
                                <td>                                                   
                                    ...
                                    <a href="<?php echo base_url() . "index.php/student/field_details/" . $loop->id; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                        View
                                    </a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input multiple="" class="form-control" type="file" required name="userfile" id="id-input-file-3" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="form-field-username">Name</label>

                                    <input type="text" class="form-control" required id="title" name="name" placeholder="Name"  />

                                </div>

                                <div class="form-group">
                                    <label class="control-label" for="form-field-username">Location</label>
                                 <input type="text" class="form-control" required id="location" name="location" placeholder="Name"  />
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="form-field-9" name="notes" data-maxlength="10"></textarea>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        }).change(function ()
        {
            ...
            var dataString = 'id=' + ID + '&name=' + name + '&notes=' + notes + '&location=' + location;
            ...
            if (name.length > 0)
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() . "index.php/field/update/"; ?>",
                    data: dataString,
                    cache: false,
