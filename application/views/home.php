        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <a   href="<?php echo base_url() . "index.php/welcome/register"; ?>"> 
                                           <img  height="50px" width="50px" class="nav-user-photo" src="<?= base_url(); ?>images/man.png" alt="account" /> MY ACCOUNT
                                  </a>
                                  
                                  <a  class=""  href="<?php echo base_url() . "index.php/welcome/register"; ?>">                                           <img  height="50px" width="50px" class="nav-user-photo" src="<?= base_url(); ?>images/pub.png" alt="account" /> PUBLISH
                                       </a>
                                  <a class=""  href="<?php echo base_url() . "index.php/welcome/register"; ?>"> 
                                          <img  height="50px" width="50px" class="nav-user-photo" src="<?= base_url(); ?>images/gps.png" alt="account" /> LOCATIONS
                                       </a><!--/.brand-->
