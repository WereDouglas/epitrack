                                            ...
                                            <div id="edit-basic" class="tab-pane in active">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span8">
                                                        ...
                                                        <div class="control-group">
                                                            <label class="control-label" for="form-field-username">Primary e-mail</label>

                                                            <div class="controls">
                                                                <input type="text" id="form-field-username" placeholder="e-mail"  />
                                                            </div>
                                                        </div>
                                                        <div class="control-group">
                                                            ...
                                                            <div class="control-group">
                                                                <label class="control-label" for="id-date-picker-1">Date Picker</label>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls" id="address">
                                                                    ...
                                                                    <input class="field" id="street_number" hidden="true" disabled="true"></input>
                                                                    <input class="field" id="route" hidden="true"  disabled="true"></input>
                                                                    <input class="field" id="locality" hidden="true"     disabled="true"></input>
                                                                    <input class="field" hidden="true" id="administrative_area_level_1" disabled="true"></input>
                                                                    <input class="field" hidden="true" id="postal_code"></input><label>Country</label>
