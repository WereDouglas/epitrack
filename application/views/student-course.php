...
<div class="col-xs-12">
    <h3><?php echo $this->session->userdata('name'); ?>'s Short Courses</h3>
    <?php echo $this->session->flashdata('msg'); ?>
    <a href="javascript:void(0);" class="add_user" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus-square"></i> <span> Add short course</span> </a>
                                    ...
                                    foreach ($out as $loop) {
                                        ...
                                        <tr id="<?php echo $id; ?>" class="edit_tr">
                                            ...
                                            <td class="td-actions">
                                                ...
                                                <a href="<?php echo base_url() . "index.php/student/course/delete/" . $loop->id; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                    <span class="red">
                                            ...
                                            <td class="td-actions">
                                                ...
                                                <a href="<?php echo base_url() . "index.php/student/course_details/" . $loop->id; ?>" class="tooltip-error" data-rel="tooltip" title="Read more">
                                                    <span class="red">
                                                        Read more
                ...
                <div class="control-group form">
                    <div class="controls">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control limited" required id="form-field-9" name="objective" data-maxlength="50"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Start</label>  
                            <input name="start" id="start" class="easyui-datebox control-group form-control" >
                        </div>

                        <div class="form-group"> 
                            <label>End</label>  
                            <input name="end" id="end" class=" form-control easyui-datebox control-group" >
                        </div>                    

                        <div class="form-group">
                            <label>What's your role</label>
                            <select id="lab" name="role" class="form-control" >
                                <option value="participant" />participant
                                <option value="instructor" />instructor
                        ...
                        <div class="form-group">
                            <label class="label-top">Course description</label>
                              <textarea class="form-control limited" id="form-field-9" required name="description" data-maxlength="20"></textarea>
