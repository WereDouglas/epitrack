                                        ...
                                        <div class="span12"> 
                                            <div class="control-group">
                                                <div class="controls">
                                                    ...
                                                    <label class="control-label" for="form-field-username">Country of employement</label>
                                                    <div class="controls">
                                                    ...
                                                    <div style="margin-bottom:20px">
                                                        ...
                                                        <input name="startDate" id="startDate" class="easyui-datebox control-group" >
                                                    </div>
                                                    <div style="margin-bottom:20px">
                                                        <label class="label-top">End Date:</label>
