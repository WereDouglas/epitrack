...
<div class="col-xs-12">
    ...
    <h3><?php echo $this->session->userdata('name'); ?>'s surveillance</h3>
    <?php echo $this->session->flashdata('msg'); ?>
    <a href="javascript:void(0);" class="add_user" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus-square"></i> <span> New surveillance</span> </a>
    ...
    <div class="row-fluid">
        ...
        <!--                                                        <input type="text" value="<?php echo $type; ?>" class="editbox" id="type_input_<?php echo $id; ?>"
                                                        ...
                                                        <select  name="type" class="editbox" id="type_input_<?php echo $id; ?>" >
                                                            ...
                                                            <option value="Active" title="Passive">Active</option>
                                                            <option value="Sentinel" title="Passive">Sentinel</option>
                                                            <option value="Laboratory" title="Passive">Laboratory</option>
                                                            <option value="Syndromic" title="Passive">Syndromic</option>
                                                            <option value="Event Based" title="Passive">Event Based</option>
                                                            <option value="Community Based" title="Passive">Community Based</option>
                                                        </select>
                                                    </td>   
        ...
        <!--                                                        <input type="text" value="<?php echo $location; ?>" class="editbox" id="region_input_<?php echo $id; ?>"-->

                                                        <select   name="country" class="editbox" id="location_input_<?php echo $id; ?>" >                                                            
                                                            <option value="<?php echo $location; ?>" title="<?php echo $location; ?>"><?php echo $region; ?></option>                                                          
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">NEW SURVEILLANCE RECORD</h4>
            </div>

            <form  role= "form" id="station-form" name="station-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/student/surveillance'  method="post">            
                <div class="control-group form">
                    <div class="controls">
                        <div class="form-group">
                            <label>Surveillance name/Title:</label>                        
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        }).change(function ()
        {
            ...
            var dataString = 'id=' + ID + '&name=' + name + '&location=' + location + '&finding=' + finding + '&type=' + type;
